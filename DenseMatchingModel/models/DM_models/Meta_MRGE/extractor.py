...
class MultiBasicEncoder(nn.Module):
    def __init__(self, cfgs, output_dim=[128], norm_fn='batch', dropout=0.0, downsample=3):
        ...
        self.conv1 = nn.Conv2d(cfgs.MODEL.NUM_INCHANNELS, 64, kernel_size=7, stride=1 + (downsample > 2), padding=3)
        self.relu1 = nn.ReLU(inplace=True)
